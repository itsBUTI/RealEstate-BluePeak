            ...
            <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-5">
              ...
              <div className="mt-4 grid gap-3">
                <label className="grid gap-1">
                  <span className="text-xs font-semibold text-slate-700">Location or keyword</span>
                  <input
                    value={form.location}
                    onChange={(e) => setForm((p) => ({ ...p, location: e.target.value }))}
                    placeholder="e.g. New York, SoHo, Penthouse"
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <label className="grid gap-1">
                    <span className="text-xs font-semibold text-slate-700">Min price</span>
                    <input
                      type="number"
                      min="0"
                      value={form.minPrice}
