      ...
      >
            ...
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-xs font-semibold text-white/90">
                <img
                  ...
                  referrerPolicy="no-referrer"
                />
                Curated inventory • Verified details
              </div>
              <h1 className="mt-4 text-3xl font-semibold tracking-tight text-white sm:text-4xl">
                Properties
              </h1>
              <p className="mt-3 text-sm leading-6 text-white/80 sm:text-base">
                Filter by location, type, bedrooms, size, and price to find the right match.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">
                Use filters to refine results. Switch between grid and list view.
              </p>
            </div>
          ...
          <div className="mt-8 grid gap-4 rounded-2xl border border-slate-200 bg-surface-50 p-4 lg:grid-cols-12 lg:items-end">
            ...
            <label className="grid gap-1 lg:col-span-2">
              <span className="text-xs font-semibold text-slate-700">Min size (m²)</span>
              <input
                type="number"
                min="0"
            ...
            <label className="grid gap-1 lg:col-span-2">
              <span className="text-xs font-semibold text-slate-700">Rooms (min)</span>
              <input
                type="number"
                min="0"
