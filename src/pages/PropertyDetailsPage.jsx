...
export function PropertyDetailsPage() {
  ...
  const onContactAgent = handleSubmit(async (values) => {
    ...
    try {
      ...
      setSendStatus({ type: 'success', message: 'Message sent. The agent will contact you shortly.' })
      reset({
        name: '',
        email: '',
        phone: '',
    ...
    <>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white">
                <div className="px-6 py-5">
                  ...
                  <div className="mt-2 text-sm text-slate-600">
                    Approximate map for {property.location}
                  </div>
                </div>
                <iframe
                  title="Google Maps"
            ...
            <div className="lg:col-span-5">
              <div className="sticky top-20 space-y-6">
                <div className="rounded-2xl border border-slate-200 bg-white p-6">
                  <div className="text-sm font-semibold text-slate-900">Agent</div>
                  {agent ? (
                    ...
                    <div className="mt-3 text-sm text-slate-600">Agent information unavailable.</div>
                  )}
                </div>

                <div className="rounded-2xl border border-slate-200 bg-white p-6">
                  <div className="text-sm font-semibold text-slate-900">Contact the agent</div>
                  <form
          ...
          {similar.length ? (
            <div className="mt-12">
              <div className="text-sm font-semibold text-slate-900">Similar properties</div>
